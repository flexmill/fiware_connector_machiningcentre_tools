...
local_path =  r'\Irkfish' #Path to file of machining centre runtimes that were exported by IRKSFISH_A.SPF, IRKSFISH_E.SPF and irkfish_copy.py
local_path_tool = '\Tool_Life' #Path to file of machining centre tool lifes that were exported by TOOL_LIFE.SPF and irkfish_copy.py
sim_path = r'\Original_SIM' #Path to simulated runtimes for definition of ideal cycle times
machines = ['1065', '1045,'] #List of machining centres that shall be observed 
